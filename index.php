...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/tasteproz.png" alt="" height=25px width=150> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/top.png" height= width= >
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/tasteproz.png" height=25px width=150 alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
